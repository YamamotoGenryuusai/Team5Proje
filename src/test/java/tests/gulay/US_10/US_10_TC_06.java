...
public class US_10_TC_06 extends TestBaseRapor {
...
@Test
    ...
    extentTest=extentReports.createTest("Enquiries Details penceresinde phone yazisi goruntuleme testi");
    ...
    extentTest.pass("Phone yazisinin goruntulendigini dogrulandi");
